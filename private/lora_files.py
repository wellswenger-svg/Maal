...
LORA_FILES = {
    ...
    # Lurulf Wet Clothes/Hair V1 — 292MB Flux.1 D (Civitai 1459149). Stronger than Invisidude 36MB.
    ...
    # getphat POV Blowjob FLUX (bl0j0) — 584MB Flux.1 D. Tiny 19MB Keltezaa rank-8 does not drive the act.
